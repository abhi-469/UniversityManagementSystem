...
public class AddFaculty implements ActionListener {
	...
	public AddFaculty()
	{
        ...
        String dept[] = {"Computer Science","Electronics","Electrical","Mechanical","Civil"};
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			...
			String query="insert into teacher values('"+name+"','"+fname+"','"+age+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+class10+"','"+class12+"','"+aadhar+"','"+course+"','"+empid+"','"+dept+"')";
			try
			{
				Conn c=new Conn();
