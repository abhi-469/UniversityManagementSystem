...
public class UpdateFaculty implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b)
		{
			String emp=t.getText();
			
			String q="select * from teacher where emp_id='"+emp+"'";
			try
			{
				Conn con=new Conn();
		...
		else if(ae.getSource()==b1)
		{
			...
			String dept=t15.getText();
			String emp=t.getText();
			
			
			String query="update teacher set name='"+name+"',fathers_name='"+fname+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',class_x='"+class10+"',class_xii='"+class12+"',aadhar='"+aadhar+"',emp_id='"+empid+"',course='"+course+"',dept='"+dept+"' where emp_id='"+emp+"'";
			try
			{
				Conn c=new Conn();
