...
public class FacultyDetail extends JFrame implements ActionListener{
	...
	String h[]= {"Name","Father's name","Age","DOB","Address","Phone","Email","10th","12th","Aadhar","Emp id","Course","Dept"};
	String d[][]=new String[50][13];
	
	
	public FacultyDetail()
	{
		super("Faculty Detail");
		...
		l1=new JLabel("Enter Id To Delete Employee :");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			...
			String q="delete from teacher where emp_id='"+roll+"'";
